...
void bx_instr_phy_access(unsigned cpu, bx_address phy, unsigned len, unsigned memtype, unsigned rw, unsigned access, Bit8u* dataptr);
void bx_instr_phy_access_rmw(unsigned cpu, bx_address phy, unsigned len, unsigned memtype, unsigned rw, unsigned access, Bit8u* dataptr);
...
#define BX_INSTR_PHY_ACCESS(cpu_id, phy, len, memtype, rw, access, dataptr)  bx_instr_phy_access(cpu_id, phy, len, memtype, rw, access, dataptr)

/* physical memory access rmw*/
#define BX_INSTR_PHY_ACCESS_RMW(cpu_id, phy, len, memtype, rw, access, dataptr)  bx_instr_phy_access_rmw(cpu_id, phy, len, memtype, rw, access, dataptr)
