...
void* bx_dbg_get_dump_log_info(char*, char*, char*);
void bx_dbg_info_registers_command_dump(int);
...
void bx_dbg_print_avx_state_dump(unsigned);
...
FILE* bx_dbg_set_dump_log_handler(char *);
...
void bx_dbg_check_mini_dump(const Bit8u *opcode, unsigned length, unsigned long long instr_num, int*,int*);
