...
*/
  ...
  //dbg_dump_printf("RDMSR: read %08x:%08x from MSR %x\n", GET32H(val64), GET32L(val64), index); //Ken 2016-03-01
...
bx_bool BX_CPP_AttrRegparmN(2) BX_CPU_C::rdmsr_dump(Bit32u index, Bit64u *msr)
{
  Bit64u val64 = 0;
