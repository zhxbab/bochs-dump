/////////////////////////////////////////////////////////////////////////
// $Id: smm.cc 12658 2015-02-20 21:50:59Z sshwarts $
/////////////////////////////////////////////////////////////////////////
//
...
void BX_CPU_C::enter_system_management_mode(void)
{
  ...
  dbg_dump_printf("Enter to System Management Mode\n");
...
// BX_NOTIFY_PHY_MEMORY_ACCESS(base, 4, BX_MEMTYPE_WB, BX_WRITE, BX_SMRAM_ACCESS, (Bit8u*)(&saved_state[n]));
    bx_dbg_phy_memory_access_dump(BX_CPU_ID, base, 4, BX_MEMTYPE_WB, BX_WRITE, BX_SMRAM_ACCESS, (Bit8u*)(&saved_state[n]));
    bx_dbg_set_smm_flag(1);//Ken added
  }
